...
$3/clang++ -DOMITBAD -DINCLUDEMAIN $4 -I $2 $2/io.c *.cpp -o test_good.out > good_out_compile.out >> good_out_compile.err
...
$3/clang++ -DOMITGOOD -DINCLUDEMAIN $4 -I $2 $2/io.c *.cpp -o test_bad.out > bad_out_compile.out >> bad_out_compile.err
